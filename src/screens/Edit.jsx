...
const Edit = () => {
    ...
    const onFormSubmit = async (e) => {
        ...
        console.log(gym);
        await axios.post(`/gyms/${gymid}/update`, gym)
        .then((res) => {
  ...
  return (
    ...
    <form className='ml-5 mt-5' onSubmit={onFormSubmit}>
        <div>
            ...
            <input type="text" id="title" name="title" defaultValue={gym?.title || ""} className='appearance-none rounded-lg relative block
        ...
        <div>
            ...
            <input type="text" id="location" name="location" defaultValue={gym?.location || ""} className='appearance-none rounded-lg relative block
                  w-1/5 px-3 py-2 border border-gray-300
                  placeholder-gray-500 text-gray-900 rounded-t-md
                  focus:outline-none focus:ring-indigo-500
                  focus:border-indigo-500 focus:z-10 sm:text-sm mt-2' />
